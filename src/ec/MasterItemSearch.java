...
@WebServlet("/MasterItemSearch")
public class MasterItemSearch extends HttpServlet {
	private static final long serialVersionUID = 1L;
	final static int PAGE_MAX_ITEM_COUNT = 16;

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.getRequestDispatcher(EcHelper.MASTER_ITEM_SEARCH_PAGE).forward(request, response);
	}
